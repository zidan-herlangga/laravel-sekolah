...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom shadow-sm">
            ...
            <a href="{{ route('home') }}" class="nav-link caret-neutral-400">Visit Site</a>

            <ul class="navbar-nav ml-auto">
                <!-- Unread Messages: KHUSUS ADMIN -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <div class="img-circle elevation-2 bg-amber-600 d-flex align-items-center justify-content-center text-white font-weight-bold"
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- Menu Konten (Hanya Admin & Penulis) -->
                        ...
                        <!-- Menu SPMB (Hanya Admin & User SPMB) -->
                        @if (in_array(auth()->user()->role, ['admin', 'spmb']))
                            <li class="nav-header">PPDB (SPMB)</li>
                            <li class="nav-item">
    ...
    <script src="https://cdn.tiny.cloud/1/byvnra3fq3p3q64qd39ypde1ai5l2wi8aq5b4yqamuhxajf1/tinymce/6/tinymce.min.js"
