        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <div class="img-circle elevation-2 bg-amber-600 d-flex align-items-center justify-content-center text-white font-weight-bold" style="width:34px;height:34px;font-size:14px;">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">
                            {{ auth()->user()->name }}
                            <!-- Badge Role -->
                            <span class="badge {{ auth()->user()->role === 'admin' ? 'badge-danger' : 'badge-info' }}" style="font-size: 10px;">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <!-- Menu Konten (Tampil untuk Admin & Penulis) -->
