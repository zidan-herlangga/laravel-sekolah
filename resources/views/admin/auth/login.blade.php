...
<head>
    ...
    <style>
        ...
        .login-card-body { border-radius: 16px; border: none; }
        .login-logo a { color: #d97706; }
        .btn-primary { background-color: #d97706; border-color: #b45309; }
        .btn-primary:hover:not(:disabled) { background-color: #b45309; border-color: #92400e; }
        .btn-primary:disabled { background-color: #9ca3af; border-color: #6b7280; cursor: not-allowed; }
        .alert-ban { background-color: #fef2f2; color: #991b1b; border: 1px solid #fecaca; border-radius: 8px; }
    </style>
</head>
<body class="hold-transition login-page" style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%);">

<div class="login-box">
    <div class="login-logo mb-4">
        <a href="{{ route('home') }}">
            <i class="fas fa-graduation-cap mr-2"></i><b>SUI</b> Admin
        </a>
    </div>
    ...
    <div class="card login-card-body shadow-lg">
        ...
        <div class="alert-ban p-3 mb-4 text-center" id="ban-alert">
            ...
            <div class="font-weight-bold text-2xl text-red-600" id="countdown-timer">{{ $wait_time }} detik</div>
        </div>
        @endif
        ...
        <form method="POST" action="{{ route('admin.login') }}" id="login-form">
            ...
            <div class="input-group mb-3">
                <input type="email" name="email" value="{{ old('email') }}" required autofocus
                    ...
                    placeholder="Email" @if($banned) disabled @endif>
            ...
            <div class="input-group mb-3">
                <input type="password" name="password" required
                    ...
                    placeholder="Password" @if($banned) disabled @endif>
                <div class="input-group-append">
            ...
            <div class="row">
                <div class="col-8">
                    <div class="icheck-primary">
                        <input type="checkbox" id="remember" name="remember" {{ old('remember') ? 'checked' : '' }} @if($banned) disabled @endif>
                        <label for="remember">Ingat Saya</label>
                    </div>
                </div>
                <div class="col-4">
                    <button type="submit" class="btn btn-primary btn-block" id="login-btn" @if($banned) disabled @endif>
