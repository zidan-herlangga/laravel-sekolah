...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
                ...
                <a href="{{ route('admin.posts.index') }}" class="small-box-footer">Lihat Detail <i
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-amber">
                ...
                <a href="{{ route('admin.registrations.index') }}" class="small-box-footer">Lihat Detail <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                ...
                <a href="{{ route('admin.teachers.index') }}" class="small-box-footer">Lihat Detail <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
                ...
                <a href="{{ route('admin.contacts.index') }}" class="small-box-footer">Lihat Detail <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title font-weight-bold"><i class="fas fa-user-graduate mr-2 text-amber-600"></i>Status
                        Pendaftar SPMB</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title font-weight-bold"><i class="fas fa-chart-pie mr-2 text-info"></i>Ringkasan Konten
                    </h3>
                </div>
                <div class="card-body">
                    <div class="d-flex justify-content-around text-center py-3">
                        ...
                        <div>
                            <div class="text-3xl font-weight-bold text-primary">
                                {{ $stats['total_posts'] - $stats['published_posts'] }}</div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title font-weight-bold"><i class="fas fa-user-plus mr-2 text-amber-600"></i>Pendaftar
                        Terbaru</h3>
                </div>
                                ...
                                @forelse($recentRegistrations as $reg)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <span
                                                class="badge badge-status badge-{{ $colors[$reg->status] ?? 'secondary' }}">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title font-weight-bold"><i class="fas fa-envelope mr-2 text-danger"></i>Pesan Terbaru
                    </h3>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-4">Belum ada pesan</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
